...
function EmptyState({ title, description, action, icon: Icon = Inbox }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      action &&
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: action }),
    ],
  });
}
function ErrorState({ error }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: ["Falha ao carregar dados: ", msg],
  });
}
export { EmptyState as E, LoadingState as L, ErrorState as a };
