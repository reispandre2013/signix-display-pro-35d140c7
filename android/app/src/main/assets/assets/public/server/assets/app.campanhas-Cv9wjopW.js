...
import {
  a as useCampaigns,
  d as usePlaylists,
  s as useCreateCampaign,
  t as useUpdateCampaign,
  v as useDeleteCampaign,
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, {
                                  icon: Layers,
                                  label: "Playlist",
                                  value: playlistName(c.playlist_id),
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, {
                                  icon: Megaphone,
                                  label: "Status",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, {
                                  icon: Calendar,
                                  label: "Início",
                                  value: format(new Date(c.start_at), "dd/MM/yyyy", {
                                    locale: ptBR,
                                  }),
                                }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, {
                                  icon: Calendar,
                                  label: "Fim",
                                  value: format(new Date(c.end_at), "dd/MM/yyyy", {
                                    locale: ptBR,
                                  }),
                                }),
                              ],
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                                  onClick: () =>
                                    confirm("Excluir esta campanha?") && remove.mutate(c.id),
                                  className:
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(PrimaryButton, {
              ...
              children: create.isPending ? "Salvando…" : "Criar campanha",
            }),
          ],
        }),
      }),
...
function Stat({ icon: Icon, label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "text-foreground font-medium truncate mt-0.5",
        children: value,
      }),
    ],
  });
