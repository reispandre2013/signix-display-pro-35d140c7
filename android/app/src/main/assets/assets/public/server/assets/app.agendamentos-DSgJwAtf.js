                    ...
                    children: [
                      ...
                      days.map((d) =>
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          { className: "text-center", children: d },
                          d,
                        ),
                      ),
                    ],
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                            ...
                            children: [(7 + h).toString().padStart(2, "0"), ":00"],
                          }),
                          days.map((d, di) => {
                            ...
                            return /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                className: `h-8 rounded-md border ${match ? "bg-primary/20 border-primary/40" : "border-border/40 bg-surface/30"}`,
                                children:
                                  match &&
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                                    ...
                                    children: s.campaigns?.name ?? "Campanha",
                                  }),
