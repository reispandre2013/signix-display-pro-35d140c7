...
import {
  a5 as withPath,
  a6 as constant,
  U as svgPropertiesAndEvents,
  H as isNumber,
  a7 as upperFirst,
  r as resolveDefaultProps,
  I as useAnimationId,
  a8 as getTransitionVal,
  K as JavascriptAnimate,
  a9 as roundTemplateLiteral,
  M as interpolate,
  L as Layer,
  V as Curve,
  aa as Sector,
  ab as Rectangle,
  ac as useAppDispatch,
  ad as setActiveMouseOverItemIndex,
  ae as mouseLeaveItem,
  af as setActiveClickItemIndex,
  ag as isStacked,
  N as isNullish,
  ah as getPercentValue,
  X as isWellBehavedNumber,
  h as getStackSeriesIdentifier,
  c as createSelector,
  s as selectChartLayout,
  ai as selectChartDataWithIndexesIfNotInPanoramaPosition4,
  d as selectAxisWithScale,
  g as selectTicksOfGraphicalItem,
  k as selectUnfilteredCartesianItems,
  i as isCategoricalAxis,
  j as getBandSizeOfAxis,
  p as propsAreEqual,
  D as DefaultZIndexes,
  u as useIsPanorama,
  R as RegisterGraphicalItemId,
  S as SetLegendPayload,
  m as SetCartesianGraphicalItem,
  o as getTooltipNameProp,
  q as SetTooltipEntrySettings,
  t as noop,
  x as useNeedsClip,
  z as usePlotArea,
  v as useChartLayout,
  y as useAppSelector,
  A as getRadiusAndStrokeWidthFromDot,
  B as isClipDot,
  Z as ZIndexLayer,
  G as GraphicalItemClipPath,
  C as ActivePoints,
  E as getValueByDataKey,
  F as getCateCoordinateOfLine,
  P as LabelListFromLabelProp,
  Q as CartesianLabelListContextProvider,
  T as svgPropertiesNoEvents,
  W as Dots,
  aj as selectChartOffsetInternal,
  ak as selectAxisViewBox,
  a as selectChartDataWithIndexesIfNotInPanoramaPosition3,
  e as selectXAxisIdFromGraphicalItemId,
  f as selectYAxisIdFromGraphicalItemId,
  al as selectRootMaxBarSize,
  am as selectBarGap,
  an as selectBarCategoryGap,
  l as selectStackGroups,
  ao as selectRootBarSize,
  ap as selectCartesianAxisSize,
  n as getNormalizedStackId,
  aq as findAllByType,
  ar as getBaseValueOfBar,
  as as truncateByDomain,
  at as getCateCoordinateOfBar,
  au as selectActiveTooltipIndex,
  av as svgPropertiesNoEventsFromUnknown,
  aw as adaptEventsOfChild,
  ax as selectActiveTooltipDataKey,
  O as isNan,
  ay as mathSign,
  Y as CartesianChart,
  _ as arrayTooltipSearcher,
  $ as subDays,
  a0 as ResponsiveContainer,
  a1 as CartesianGrid,
  a2 as XAxis,
  a3 as YAxis,
  a4 as Tooltip,
} from "./subDays-D1QUdJPx.js";
...
var Trapezoid = (outsideProps) => {
  ...
  var { animationEasing, animationDuration, animationBegin, isUpdateAnimationActive } =
    trapezoidProps;
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ reactExports.createElement(
      ...
      /* @__PURE__ */ reactExports.createElement(
        "path",
        _extends$4({}, svgPropertiesAndEvents(trapezoidProps), {
...
function Shape(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    shape = /* @__PURE__ */ reactExports.cloneElement(
      option,
      _objectSpread$3(_objectSpread$3({}, props), getPropsFromShapeOption(option)),
    );
  ...
  if (barBandSize !== bandSize && allBarPositions != null) {
    allBarPositions = allBarPositions.map((pos) =>
      _objectSpread$2(
        ...
        {},
        {
          position: _objectSpread$2(
            _objectSpread$2({}, pos.position),
            {},
            {
...
var selectXAxisWithScale$1 = (state, xAxisId, _yAxisId, isPanorama) =>
  selectAxisWithScale(state, "xAxis", xAxisId, isPanorama);
var selectXAxisTicks$1 = (state, xAxisId, _yAxisId, isPanorama) =>
  selectTicksOfGraphicalItem(state, "xAxis", xAxisId, isPanorama);
var selectYAxisWithScale$1 = (state, _xAxisId, yAxisId, isPanorama) =>
  selectAxisWithScale(state, "yAxis", yAxisId, isPanorama);
var selectYAxisTicks$1 = (state, _xAxisId, yAxisId, isPanorama) =>
...
var getStrokeDasharray = (length, totalLength, lines) => {
  ...
  for (
    var i = 0, sum = 0;
    i < lines.length;
    sum += (_lines$i = lines[i]) !== null && _lines$i !== void 0 ? _lines$i : 0, ++i
  ) {
    var _lines$i;
...
function LineDotsWrapper(_ref2) {
  ...
  var { id } = props,
    propsWithoutId = _objectWithoutProperties$2(props, _excluded$2);
...
function LineLabelListProvider(_ref3) {
  ...
  var labelListEntries = reactExports.useMemo(() => {
    return points === null || points === void 0
      ? void 0
      : points.map((point) => {
...
function StaticCurve(_ref4) {
  ...
  var curveProps = _objectSpread$1(
    _objectSpread$1({}, svgPropertiesAndEvents(others)),
    {},
    {
      fill: "none",
      ...
      connectNulls,
      strokeDasharray:
        strokeDasharray !== null && strokeDasharray !== void 0
          ? strokeDasharray
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    null,
    (points === null || points === void 0 ? void 0 : points.length) > 1 &&
      /* @__PURE__ */ reactExports.createElement(
        Shape,
        _extends$3(
          {
...
class LineWithState extends reactExports.Component {
  render() {
    ...
    var activePointsClipPath = needClip
      ...
      /* @__PURE__ */ reactExports.createElement(
        ...
        needClip &&
          /* @__PURE__ */ reactExports.createElement(
            "defs",
            null,
            /* @__PURE__ */ reactExports.createElement(GraphicalItemClipPath, {
              clipPathId,
              xAxisId,
              yAxisId,
            }),
...
function LineImpl(props) {
  var _resolveDefaultProps = resolveDefaultProps(props, defaultLineProps),
    ...
    everythingElse = _objectWithoutProperties$2(_resolveDefaultProps, _excluded3$1);
...
var selectMaxBarSize = createSelector([selectSynchronisedBarSettings], (barSettings) =>
...
var selectBarPosition = createSelector(
  [selectAllBarPositions, selectSynchronisedBarSettings],
  combineBarPosition,
);
var selectStackedDataOfItem = createSelector(
...
function BarBackground(props) {
  ...
  var onMouseEnterFromContext = useMouseEnterItemDispatch(
    onMouseEnterFromProps,
    dataKey,
    allOtherBarProps.id,
  );
  var onMouseLeaveFromContext = useMouseLeaveItemDispatch(onMouseLeaveFromProps);
  var onClickFromContext = useMouseClickItemDispatch(
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    data.map((entry, i) => {
      ...
      var barRectangleProps = _objectSpread(
        _objectSpread(
          _objectSpread(
            _objectSpread(
              _objectSpread(
...
function BarRectangleWithActiveState(props) {
  ...
  var content = /* @__PURE__ */ reactExports.createElement(
    BarRectangle,
    _extends(
      {},
      baseProps,
...
function BarRectangles(_ref3) {
  ...
  var _ref4 =
      (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null &&
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    data.map((entry, i) => {
      return /* @__PURE__ */ reactExports.createElement(
        ...
        activeBar
          ? /* @__PURE__ */ reactExports.createElement(BarRectangleWithActiveState, {
              shape,
              activeBar,
              baseProps,
              entry,
  ...
  return /* @__PURE__ */ reactExports.createElement(
    ...
    /* @__PURE__ */ reactExports.createElement(
      ...
      (t) => {
        ...
        if (t > 0) {
          previousRectanglesRef.current =
            stepData !== null && stepData !== void 0 ? stepData : null;
        }
        if (stepData == null) {
          return null;
        }
        return /* @__PURE__ */ reactExports.createElement(
          Layer,
          null,
          /* @__PURE__ */ reactExports.createElement(BarRectangles, {
            props,
            data: stepData,
          }),
        );
...
function computeBarRectangles(_ref6) {
  ...
  return displayedData
    .map((entry, index) => {
      ...
      var minPointSize = minPointSizeCallback(minPointSizeProp, defaultMinPointSize)(
        value[1],
        index,
      );
      if (layout === "horizontal") {
        ...
        y =
          (_ref7 =
            currentValueScale !== null && currentValueScale !== void 0
              ? currentValueScale
              : baseValueScale) !== null && _ref7 !== void 0
            ? _ref7
            : void 0;
        width = pos.size;
      ...
      var barRectangleItem = _objectSpread(
        _objectSpread({}, entry),
        {},
        {
          stackedBarStart,
                          ...
                          "tr",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("td", {
                                ...
                                children: c2.priority,
                              }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("td", {
                                className: "px-5 py-3.5",
                                children: format(new Date(c2.start_at), "dd/MM/yyyy"),
                              }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("td", {
                                className: "px-5 py-3.5",
                                children: format(new Date(c2.end_at), "dd/MM/yyyy"),
                              }),
                            ],
                          },
                          c2.id,
