...
import { c as useAlerts, b as useScreens, x as useResolveAlert } from "./use-supabase-data-DWtjSxP7.js";
...
function AlertsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Alertas e falhas", subtitle: "Eventos detectados nos players com nível de severidade." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { bodyClassName: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingState, {}) : error ? /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorState, { error }) : alerts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: BellOff, title: "Nenhum alerta registrado", description: "Os alertas dos seus players aparecem aqui em tempo real." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border", children: alerts.map((a) => {
      const resolved = !!a.resolved_at;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-4 px-5 py-4 hover:bg-surface/40 transition-colors", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-9 w-9 rounded-lg grid place-items-center shrink-0 ${resolved ? "bg-success/10 text-success" : "bg-destructive/10 text-destructive"}`, children: resolved ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: a.alert_type }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { tone: sevTone[a.severity], label: sevLabel[a.severity], withDot: false })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1.5", children: a.message })
        ] }),
        !resolved ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: resolve.isPending, onClick: () => resolve.mutate(a.id), className: "text-xs rounded-md border border-border bg-surface px-2.5 py-1 hover:bg-accent disabled:opacity-50", children: "Resolver" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { tone: "success", label: "Resolvido", withDot: false })
      ] }, a.id);
    }) }) })
  ] });
}
