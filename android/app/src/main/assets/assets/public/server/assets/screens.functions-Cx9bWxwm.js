...
const claimPairingCode = createServerFn({
  method: "POST"
}).inputValidator(validate).handler(createSsrRpc("6386b86a2fd8e8f0fed58b3c0a030b1caf0a3fee64720726efb088e0ae319e6d"));
...
export {
  Cpu as C,
  checkPairingStatus as a,
  claimPairingCode as b,
  createPairingCode as c
};
