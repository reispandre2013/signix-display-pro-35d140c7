...
function SettingsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, {
        title: "Conta",
        children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, {
            title: "Aparência",
            actions: /* @__PURE__ */ jsxRuntimeExports.jsx(Palette, {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, {
                          className: "h-5 w-5 text-warning mb-2",
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                          className: "text-sm font-medium",
                          children: "Light",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, {
            title: "Notificações",
            actions: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, {
              className: "h-4 w-4 text-muted-foreground",
            }),
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: n, on: i % 2 === 0 }, n),
              ),
            }),
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, {
            title: "Segurança",
            actions: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, {
              className: "h-4 w-4 text-muted-foreground",
            }),
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "space-y-3",
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, {
                  label: "Forçar troca de senha a cada 90 dias",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, {
                  label: "Bloquear sessão após 30min ociosa",
                  on: true,
                }),
              ],
            }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, {
            title: "Localização",
            actions: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, {
              className: "h-4 w-4 text-muted-foreground",
            }),
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "space-y-3",
