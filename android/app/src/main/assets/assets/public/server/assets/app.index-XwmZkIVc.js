  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: cn("absolute inset-0 bg-gradient-to-br opacity-60", tones[tone]),
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: cn("h-10 w-10 rounded-lg grid place-items-center", `bg-${tone}/10`),
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, {
              className: cn("h-5 w-5", tones[tone].split(" ").pop()),
            }),
          }),
        ],
      }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
              className: delta.up ? "text-success" : "text-destructive",
              children: delta.value,
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
              className: "text-muted-foreground",
              children: "vs. semana anterior",
            }),
          ],
        }),
    ],
...
var selectXAxisWithScale = (state, graphicalItemId, isPanorama) =>
  selectAxisWithScale(
    state,
    "xAxis",
...
var selectXAxisTicks = (state, graphicalItemId, isPanorama) =>
...
var selectYAxisWithScale = (state, graphicalItemId, isPanorama) =>
  selectAxisWithScale(
    state,
    "yAxis",
...
var selectYAxisTicks = (state, graphicalItemId, isPanorama) =>
  selectTicksOfGraphicalItem(
    state,
    "yAxis",
    selectYAxisIdFromGraphicalItemId(state, graphicalItemId),
...
var selectSynchronisedAreaSettings = createSelector(
...
var selectNumericalAxisStackGroups = (state, graphicalItemId, isPanorama) =>
  selectStackGroups(
    state,
...
var selectGraphicalItemStackedData = createSelector(
  ...
  (areaSettings, stackGroups) => {
    ...
    var groups =
      (_stackGroups$stackId = stackGroups[stackId]) === null || _stackGroups$stackId === void 0
        ? void 0
        : _stackGroups$stackId.stackedData;
    var found =
      groups === null || groups === void 0
        ? void 0
        : groups.find((v) => v.key === stackSeriesIdentifier);
    if (found == null) {
      return void 0;
    }
...
function VerticalRect(_ref5) {
  ...
  var endY =
    (_points = points[points.length - 1]) === null || _points === void 0 ? void 0 : _points.y;
...
function HorizontalRect(_ref6) {
  ...
  var endX =
    (_points2 = points[points.length - 1]) === null || _points2 === void 0 ? void 0 : _points2.x;
...
function AreaImpl(props) {
  ...
  var { points, isRange, baseLine } =
    (_useAppSelector = useAppSelector((state) => selectArea(state, props.id, isPanorama))) !==
...
function computeArea(_ref0) {
  ...
  var points = displayedData.map((entry, index) => {
    ...
    var value1 =
      (_valueAsArray$ =
        (_valueAsArray = valueAsArray) === null || _valueAsArray === void 0
          ? void 0
          : _valueAsArray[1]) !== null && _valueAsArray$ !== void 0
        ? _valueAsArray$
        : null;
    var isBreakPoint =
    ...
    if (isHorizontalLayout) {
      ...
      return {
        ...
        y: isBreakPoint
          ? null
          : (_yAxis$scale$map = yAxis.scale.map(value1)) !== null && _yAxis$scale$map !== void 0
            ? _yAxis$scale$map
            : null,
        value: valueAsArray,
        payload: entry,
    ...
    return {
      x: isBreakPoint
        ? null
        : (_xAxis$scale$map = xAxis.scale.map(value1)) !== null && _xAxis$scale$map !== void 0
          ? _xAxis$scale$map
          : null,
    ...
    baseLine = points.map((entry) => {
      ...
      if (isHorizontalLayout) {
        ...
        return {
          ...
          y:
            x != null && entry.y != null
              ? (_yAxis$scale$map2 = yAxis.scale.map(x)) !== null && _yAxis$scale$map2 !== void 0
                ? _yAxis$scale$map2
                : null
              : null,
      ...
      return {
        x:
          x != null
            ? (_xAxis$scale$map2 = xAxis.scale.map(x)) !== null && _xAxis$scale$map2 !== void 0
              ? _xAxis$scale$map2
              : null
            : null,
        y: entry.y,
...
function Dashboard() {
  ...
  const problemDevices = screens
    .filter((s) => s.device_status === "offline" || s.device_status === "warning")
    .slice(0, 5);
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, {
                    ...
                    icon: Wifi,
                    tone: "success",
                    hint: total ? `${Math.round((online / total) * 100)}% disponibilidade` : "—",
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, {
                    label: "Offline",
                    value: offline,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, {
                    ...
                    value: mediaQ.data?.length ?? 0,
                    icon: Image,
                    tone: "primary",
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, {
                    label: "Playlists",
                    value: playlistsQ.data?.length ?? 0,
                    icon: ListVideo,
                    tone: "success",
                  }),
                ],
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, {
                          label: "Sincronizando",
                          value: screens.filter((s) => s.device_status === "syncing").length,
                          total,
                          color: "bg-info",
                        }),
                      ],
                                      ...
                                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                                        ...
                                        children: [
                                          ...
                                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
                                            ...
                                            children: ["Prioridade ", c.priority],
                                          }),
                                        ],
                                      }),
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "li",
                                {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, {
                                      tone:
                                        s.device_status === "offline" ? "destructive" : "warning",
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                                      ...
                                      children: [
                                        ...
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                                          className: "text-[11px] text-muted-foreground",
                                          children: formatDistanceToNow(new Date(a.created_at), {
                                            locale: ptBR,
                                            addSuffix: true,
                                          }),
                                        }),
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, {
                                      tone: a.resolved_at ? "success" : "warning",
                                      label: a.resolved_at ? "Resolvido" : "Pendente",
                                      withDot: false,
                                    }),
                                  ],
                                },
