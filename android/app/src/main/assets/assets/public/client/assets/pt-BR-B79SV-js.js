import { h as s, i, j as r, k as d } from "./en-US-DfnapdEA.js";
const m = {
  ...
  u = (e, a, t) => {
    ...
    return (
      typeof n == "string"
        ...
        : a === 1
          ? (o = n.one)
          : (o = n.other.replace("{{count}}", String(a))),
      t?.addSuffix ? (t.comparison && t.comparison > 0 ? "em " + o : "há " + o) : o
    );
  },
  c = {
  ...
  h = { full: "HH:mm:ss zzzz", long: "HH:mm:ss z", medium: "HH:mm:ss", short: "HH:mm" },
  l = {
    full: "{{date}} 'às' {{time}}",
    long: "{{date}} 'às' {{time}}",
    medium: "{{date}}, {{time}}",
  ...
  f = {
    date: s({ formats: c, defaultWidth: "full" }),
    time: s({ formats: h, defaultWidth: "full" }),
    dateTime: s({ formats: l, defaultWidth: "full" }),
  },
  b = {
    lastWeek: (e) => {
      const a = e.getDay();
  ...
  W = {
    ...
    quarter: i({ values: P, defaultWidth: "wide", argumentCallback: (e) => e - 1 }),
    month: i({ values: v, defaultWidth: "wide" }),
    day: i({ values: w, defaultWidth: "wide" }),
    dayPeriod: i({
      values: y,
      defaultWidth: "wide",
      formattingValues: M,
  ...
  k = { any: [/^ac/i, /^dc/i], wide: [/^antes de cristo/i, /^depois de cristo/i] },
  z = { narrow: /^[1234]/i, abbreviated: /^T[1234]/i, wide: /^[1234](º)? trimestre/i },
  ...
  E = {
    ordinalNumber: d({ matchPattern: q, parsePattern: x, valueCallback: (e) => parseInt(e, 10) }),
    era: r({
      matchPatterns: D,
