...
function at(t, ...e) {
  const n = y.bind(null, t || e.find((a) => typeof a == "object"));
  return e.map(n);
}
const p = {
...
const P = { full: "EEEE, MMMM do, y", long: "MMMM do, y", medium: "MMM d, y", short: "MM/dd/yyyy" },
  M = { full: "h:mm:ss a zzzz", long: "h:mm:ss a z", medium: "h:mm:ss a", short: "h:mm a" },
  W = {
    full: "{{date}} 'at' {{time}}",
    long: "{{date}} 'at' {{time}}",
    medium: "{{date}}, {{time}}",
  ...
  k = {
    ...
    dateTime: l({ formats: W, defaultWidth: "full" }),
  },
  D = {
...
function d(t) {
  return (e, n) => {
    ...
    if (a === "formatting" && t.formattingValues) {
      ...
      r = t.values[i] || t.values[o];
    }
    const s = t.argumentCallback ? t.argumentCallback(e) : e;
    return r[s];
  };
}
const F = { narrow: ["B", "A"], abbreviated: ["BC", "AD"], wide: ["Before Christ", "Anno Domini"] },
  C = {
    narrow: ["1", "2", "3", "4"],
  ...
  O = {
    ordinalNumber: z,
    era: d({ values: F, defaultWidth: "wide" }),
    quarter: d({ values: C, defaultWidth: "wide", argumentCallback: (t) => t - 1 }),
    month: d({ values: j, defaultWidth: "wide" }),
    day: d({ values: x, defaultWidth: "wide" }),
    dayPeriod: d({
      values: A,
      defaultWidth: "wide",
      formattingValues: T,
...
function c(t) {
  return (e, n = {}) => {
    ...
    const o = s[0],
      ...
      h = Array.isArray(i) ? q(i, (m) => m.test(o)) : V(i, (m) => m.test(o));
    let u;
    ((u = t.valueCallback ? t.valueCallback(h) : h),
...
const N = /^(\d+)(th|st|nd|rd)?/i,
  ...
  Y = { any: [/^b/i, /^(a|c)/i] },
  E = { narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i },
  ...
  K = {
    ordinalNumber: J({ matchPattern: N, parsePattern: X, valueCallback: (t) => parseInt(t, 10) }),
    era: c({
      matchPatterns: I,
