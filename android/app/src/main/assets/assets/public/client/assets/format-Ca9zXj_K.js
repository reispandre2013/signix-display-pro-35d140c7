...
function W(n, t) {
  ...
  const f = O(i);
  return e.getTime() >= s.getTime() ? r + 1 : e.getTime() >= f.getTime() ? r : r - 1;
}
function D(n, t) {
  const e = d(n, t?.in);
...
function v(n, t, e) {
  const [r, a] = N(e?.in, n, t),
    s = D(r),
    i = D(a),
    f = +s - Y(s),
    h = +i - Y(i);
  return Math.round((f - h) / F);
}
function C(n, t) {
  const e = W(n, t),
    r = w(n, 0);
  return (r.setFullYear(e, 0, 4), r.setHours(0, 0, 0, 0), O(r));
}
function G(n) {
  return (
    n instanceof Date ||
...
function Q(n) {
  return !((!G(n) && typeof n != "number") || isNaN(+d(n)));
}
function _(n, t) {
  const e = d(n, t?.in);
...
function L(n, t) {
  const e = b(),
    ...
    a = E(n, t),
    s = w(t?.in || n, 0);
  return (s.setFullYear(a, 0, r), s.setHours(0, 0, 0, 0), y(s, t));
}
function I(n, t) {
  const e = d(n, t?.in),
    r = +y(e, t) - +L(e, t);
...
function o(n, t) {
  const e = n < 0 ? "-" : "",
    r = Math.abs(n).toString().padStart(t, "0");
  return e + r;
}
const m = {
    y(n, t) {
    ...
    S(n, t) {
      const e = t.length,
        r = n.getMilliseconds(),
        a = Math.trunc(r * Math.pow(10, e - 3));
      return o(a, t.length);
    },
  },
  g = {
  ...
  M = {
    ...
    Y: function (n, t, e, r) {
      ...
      return t === "Yo" ? e.ordinalNumber(s, { unit: "year" }) : o(s, t.length);
    },
    R: function (n, t) {
      const e = W(n);
      return o(e, t.length);
    ...
    Q: function (n, t, e) {
      ...
      switch (t) {
        ...
        case "QQQ":
          return e.quarter(r, { width: "abbreviated", context: "formatting" });
        case "QQQQQ":
    ...
    q: function (n, t, e) {
      ...
      switch (t) {
        ...
        case "qo":
          return e.ordinalNumber(r, { unit: "quarter" });
        case "qqq":
          return e.quarter(r, { width: "abbreviated", context: "standalone" });
        case "qqqqq":
    ...
    M: function (n, t, e) {
      ...
      switch (t) {
        ...
        case "MMM":
          return e.month(r, { width: "abbreviated", context: "formatting" });
        case "MMMMM":
    ...
    L: function (n, t, e) {
      ...
      switch (t) {
        ...
        case "Lo":
          return e.ordinalNumber(r + 1, { unit: "month" });
        case "LLL":
          return e.month(r, { width: "abbreviated", context: "standalone" });
        case "LLLLL":
    ...
    b: function (n, t, e) {
      ...
      let a;
      switch (
        (r === 12 ? (a = g.noon) : r === 0 ? (a = g.midnight) : (a = r / 12 >= 1 ? "pm" : "am"), t)
      ) {
        case "b":
        case "bb":
          return e.dayPeriod(a, { width: "abbreviated", context: "formatting" });
    ...
    k: function (n, t, e) {
      ...
      return (
        r === 0 && (r = 24),
        t === "ko" ? e.ordinalNumber(r, { unit: "hour" }) : o(r, t.length)
      );
    },
    m: function (n, t, e) {
...
function p(n, t = "") {
  const e = n > 0 ? "-" : "+",
    ...
    a = Math.trunc(r / 60),
    s = r % 60;
  return s === 0 ? e + String(a) : e + String(a) + t + o(s, 2);
}
function P(n, t) {
  return n % 60 === 0 ? (n > 0 ? "-" : "+") + o(Math.abs(n) / 60, 2) : l(n, t);
}
function l(n, t = "") {
  const e = n > 0 ? "-" : "+",
    r = Math.abs(n),
...
const T = (n, t) => {
  ...
  R = (n, t) => {
    ...
    return s.replace("{{date}}", T(r, t)).replace("{{time}}", q(a, t));
  },
  $ = { p: q, P: R },
  j = /^D+$/,
  V = /^Y+$/,
...
function U(n, t, e) {
  const r = Z(n, t, e);
  if ((console.warn(r), A.includes(n))) throw new RangeError(r);
}
function Z(n, t, e) {
...
function ot(n, t, e) {
  const r = b(),
    ...
    i =
      ...
      0,
    f = d(n, e?.in);
  if (!Q(f)) throw new RangeError("Invalid time value");
  let h = t
    .match(tt)
    .map((u) => {
      const c = u[0];
    ...
    .map((u) => {
      ...
      const c = u[0];
      if (c === "'") return { isToken: !1, value: at(u) };
      if (M[c]) return { isToken: !0, value: u };
      if (c.match(rt))
  ...
  a.localize.preprocessor && (h = a.localize.preprocessor(f, h));
  const x = { firstWeekContainsDate: s, weekStartsOn: i, locale: a };
  return h
    .map((u) => {
      if (!u.isToken) return u.value;
      const c = u.value;
      ((!e?.useAdditionalWeekYearTokens && K(c)) || (!e?.useAdditionalDayOfYearTokens && J(c))) &&
        U(c, t, String(n));
      const k = M[c[0]];
      return k(f, c, a.localize, x);
    })
    .join("");
}
function at(n) {
  const t = n.match(et);
  return t ? t[1].replace(nt, "'") : n;
}
export { ot as f };
