import { j as t } from "./index-DUcMANMA.js";
import { c as i } from "./utils-BQHNewu7.js";
const r = {
  ...
  u = { online: "Online", offline: "Offline", warning: "Atenção", syncing: "Sincronizando" };
function f({ status: n, label: s, tone: c, withDot: o = !0 }) {
  const e = c ?? n ?? "neutral",
    g = s ?? (n ? (u[n] ?? n) : "—");
  return t.jsxs("span", {
    className: i(
    ...
    children: [
      o &&
        t.jsx("span", {
          className: i("h-1.5 w-1.5 rounded-full bg-current", e === "online" && "pulse-dot"),
        }),
      g,
    ],
  });
